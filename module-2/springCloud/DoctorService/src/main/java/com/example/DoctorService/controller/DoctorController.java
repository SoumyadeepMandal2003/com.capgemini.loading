...
//        String users = restTemplate.getForObject("http://UserService/users",String.class);
        ...
        return "Doctors Fetches. Also calling -> " + users;
    }

    public String userFallback(Throwable t) {
        return " doctoe service called but --- User Service is currently unavailable.showing cached doctor data";
    }


    //using Rest Template MEthod
